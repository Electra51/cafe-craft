...
const Navbar = () => {
  ...
  return (
    <div className="bg-slate-200 shadow-lg dark:bg-slate-900 lg:pr-3">
      <nav className="navbar sticky top-0 z-10  container mx-auto px-2 ">
        <div className="flex-1">
          <Link href="/" className="h-[80px] w-[150px]">
            <Image src={logo} alt="" className="h-full w-full object-fill" />
          </Link>
        </div>
        <div
          className={`absolute ${
